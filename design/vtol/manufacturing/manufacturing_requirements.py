"""
VTOL Manufacturing Requirements

Purpose:
    Defines the `ManufacturingRequirements` class capturing layout design overrides
    and preceding stage outputs for the manufacturing package generation stage.
"""
...
class ManufacturingRequirements:
    """
    Inputs for VTOL manufacturing package.
    """
    ...
    preferred_manufacturing_strategy: str | None = None
    target_production_run_units: int = 10
