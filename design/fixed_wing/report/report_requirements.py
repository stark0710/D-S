"""
Fixed-Wing Engineering Report Requirements Subsystem

Purpose:
    Defines the `ReportRequirements` class containing all engineering result nodes.

Role in Architecture:
    `ReportRequirements` wraps preceding sizing results, CAD outputs, and manufacturing packages.
"""
...
class ReportRequirements:
    """
    Input model encapsulating preceding engineering sizing outputs.
    ...
    Attributes:
        ...
        cad_result (CADResult): Output from CAD generation.
        manufacturing_result (ManufacturingResult): Output from manufacturing package compiler.
