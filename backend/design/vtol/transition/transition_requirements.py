"""
VTOL Transition Requirements

Purpose:
    Defines the `TransitionRequirements` class capturing layout design overrides
    and preceding stage outputs for the transition stage.
"""
...
class TransitionRequirements:
    """
    Inputs for VTOL transition performance evaluation.
    """
    ...
    preferred_transition_speed_kmh: float | None = None
    preferred_transition_duration_s: float | None = None
