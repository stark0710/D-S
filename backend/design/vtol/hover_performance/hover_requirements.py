...
Purpose:
    Defines the `HoverRequirements` class capturing layout design overrides
    and preceding stage outputs for the hover performance stage.
"""
...
class HoverRequirements:
    """
    Inputs for VTOL hover performance evaluation.
    """
    ...
    preferred_hover_margin: float | None = None
    preferred_hover_altitude_m: float | None = None
