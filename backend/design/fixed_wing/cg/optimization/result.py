"""
Fixed-Wing Center of Gravity (CG) Optimization Result container
"""
...
class CGOptimizationResult(OptimizationResult):
    """
    Result container representing the selected Center of Gravity specification.
    """
    def __init__(
        self,
        winning_candidate: Any,
        generated_specification: CGSpecification | None,
        success: bool,
        message: str,
        evaluated_count: int,
        feasible_count: int,
