"""
Fixed-Wing Flight Performance Optimization Result container
"""
...
class FlightPerformanceOptimizationResult(OptimizationResult):
    """
    Result container representing the selected flight performance evaluation specification.
    """
    def __init__(
        self,
        winning_candidate: Any,
        generated_specification: FlightPerformanceSpecification | None,
        success: bool,
        message: str,
        evaluated_count: int,
        feasible_count: int,
